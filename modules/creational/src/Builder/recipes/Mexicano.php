...
use app\modules\creational\src\Builder\ingredients\Onion;
use app\modules\creational\src\Builder\ingredients\Chili;
use app\modules\creational\src\Builder\ingredients\Chicken;
use app\modules\creational\src\Builder\ingredients\Jalapeno;
...
final readonly class Mexicano implements PizzaDirectorInterface
{
    private const RECIPE_NAME = 'Мексиканская';
    ...
    public function build(): Pizza
    {
        return $this->builder
            ...
            ->addIngredient(new Jalapeno(), 50)
            ->addIngredient(new Onion(), 50)
